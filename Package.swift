...
let package = Package(
    ...
    targets: [
        .target(
            ...
            path: "Lamp",
            exclude: [
                "AgentAPIClient.swift", "AppIntents.swift", "Assets.xcassets", "DesignSystem.swift", "ImageIngestionService.swift", "Info.plist", "Lamp.entitlements", "LampActivityAttributes.swift", "LampActivityManager.swift", "LampApp.swift", "LampRestAnimation.swift", "LampStore.swift",
